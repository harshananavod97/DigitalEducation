...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Bio%20Technology%20AL/Bio_Technology_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Business%20Studies/Business_Studies_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Chemistry/Chemistry_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Economics/Economics_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Engineering%20Technology%20Al/Engineering_Technology_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Genaral%20Knowldge/Genaral_Knowldge_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/ICT%20AL/ICT_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Science%20s%20AL/Science_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Physics%20AL/Physics_Home_AL_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Maths%20AL/Maths_Home_Screen_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Science%20For%20Technology%20AL/Science_For_Technology_Al.dart';
...
class AdavancedLevelHomeScreen extends StatefulWidget {
  const AdavancedLevelHomeScreen({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<AdavancedLevelHomeScreen> createState() =>
      _AdavancedLevelHomeScreenState();

  static Route<AdavancedLevelHomeScreen> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child:
            AdavancedLevelHomeScreen(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}
...
class _AdavancedLevelHomeScreenState extends State<AdavancedLevelHomeScreen>
  ...
  List<Widget> pages = [
    Science_Home_Al(isGuest: false),
    Chimestry_Home_Screen(
      isGuest: false,
    ),
    Physics_Home_AL(
      isGuest: false,
    ...
    Engineering_Technology_Home_Al(isGuest: false),
    Bio_Technology_Home_Al(isGuest: false),
    Science_For_Technology_Home_Al(
      isGuest: false,
    ),
    Maths_Home_Al(
      isGuest: false,
    ),
    Economics_Home_Al(isGuest: false),
    Accounting_Home_Al(isGuest: false),
    Business_Studies_Home_Al(isGuest: false),
    GenaralKnowldge_Home_Al(isGuest: false)
  ];
  ...
  // AdavancedLevelHomeScreen horizontal margin, change from here
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return SubStreamContainer(
                  hzMargin: hzMargin,
                  scrHeight: scrHeight,
                  name: filteredStreamNames[index],
                  onpress: () {
                    showrewardadd(context);
                    Navigator.push(
                        context,
...
class WhatsAppJoinGroup extends StatelessWidget {
  const WhatsAppJoinGroup({
    super.key,
  });
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    Color.fromARGB(255, 254, 201, 168),
                    Color.fromARGB(211, 216, 125, 14),
                  ],
...
_displayBotomSheet(BuildContext context) {
            ...
            Row(
              ...
              children: [
                IconButton(
                    onPressed: () async {
                      String url =
                          'https://chat.whatsapp.com/L7PMuwDxVwPHBxMqQOLxER'; // Replace with your WhatsApp group invite link
                ...
                IconButton(
                    onPressed: () async {
                      String url =
                          'https://t.me/+geCDn6Ooong5MzJl'; // Replace with your WhatsApp group invite link
                      if (await canLaunch(url)) {
                        await launch(url);
                      } else {
                        throw 'Could not launch $url';
