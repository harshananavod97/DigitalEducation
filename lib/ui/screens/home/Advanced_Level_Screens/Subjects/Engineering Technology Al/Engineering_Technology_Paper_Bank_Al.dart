...
import 'package:flutterquiz/ui/controller/Engineering_Technology.dart';
...
class EnginneringTechnologyPaperBankAl extends StatefulWidget {
  String title;
  EnginneringTechnologyPaperBankAl({Key? key, required this.title})
      : super(key: key);

  @override
  State<EnginneringTechnologyPaperBankAl> createState() =>
      _EnginneringTechnologyPaperBankAlState();
}

class _EnginneringTechnologyPaperBankAlState
    extends State<EnginneringTechnologyPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: EnginneringTechnologycontroller().getItems("123"),
