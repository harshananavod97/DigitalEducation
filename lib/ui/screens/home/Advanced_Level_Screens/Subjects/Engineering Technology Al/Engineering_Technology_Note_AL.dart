...
class EnginneringTechnologyNoteAl extends StatefulWidget {
  String title;
  EnginneringTechnologyNoteAl({Key? key, required this.title})
      : super(key: key);

  @override
  State<EnginneringTechnologyNoteAl> createState() => _IctNoteAlState();
}

class _IctNoteAlState extends State<EnginneringTechnologyNoteAl> {
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight:
                              FontWeight.w400, // Corrected FontWeight value
