...
import 'package:flutterquiz/ui/controller/Al_Maths_Controller.dart';
...
class MathsPaperBankAl extends StatefulWidget {
  String title;
  MathsPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<MathsPaperBankAl> createState() => _MathsPaperBankAlState();
}

class _MathsPaperBankAlState extends State<MathsPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlMathsController().getItems("123"),
