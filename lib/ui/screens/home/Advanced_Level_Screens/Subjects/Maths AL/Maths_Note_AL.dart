...
class MathsNoteAl extends StatefulWidget {
  String title;
  MathsNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<MathsNoteAl> createState() => _MathsNoteAlState();
}

class _MathsNoteAlState extends State<MathsNoteAl> {
