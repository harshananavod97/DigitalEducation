...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Maths%20AL/Maths_Note_AL.dart';
...
class Maths_Home_Al extends StatefulWidget {
  const Maths_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Maths_Home_Al> createState() => _Science_Home_AlState();

  static Route<Maths_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Maths_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Science_Home_AlState extends State<Maths_Home_Al>
  ...
  // Maths_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Mathematics (A/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => MathsPaperBankAl(
                                            title: "Maths Paper Bank (A/L)",
                                          )));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => MathsNoteAl(
                                            title: "Maths Note (A/L)",
                                          )));
                            })
                      ],
                    );
