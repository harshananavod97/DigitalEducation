...
class BusinessStudiesNoteAl extends StatefulWidget {
  String title;
  BusinessStudiesNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<BusinessStudiesNoteAl> createState() => _BusinessStudiesNoteAlState();
}

class _BusinessStudiesNoteAlState extends State<BusinessStudiesNoteAl> {
