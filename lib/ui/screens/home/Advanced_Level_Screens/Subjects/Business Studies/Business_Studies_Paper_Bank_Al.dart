...
class AlBusinesStudyPaperBankAl extends StatefulWidget {
  String title;
  AlBusinesStudyPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<AlBusinesStudyPaperBankAl> createState() => _AlBusinesStudyPaperBankAlState();
}

class _AlBusinesStudyPaperBankAlState extends State<AlBusinesStudyPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlBusinessStudies().getItems("123"),
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Container(
          ...
          height: MediaQuery.of(context).size.width / 4.64,
          child: Padding(
