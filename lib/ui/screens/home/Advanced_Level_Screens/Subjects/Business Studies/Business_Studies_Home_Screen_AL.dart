...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Business%20Studies/Business_Studies_Note_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Business%20Studies/Business_Studies_Paper_Bank_Al.dart';
...
class Business_Studies_Home_Al extends StatefulWidget {
  const Business_Studies_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Business_Studies_Home_Al> createState() =>
      _Business_Studies_Home_AlState();

  static Route<Business_Studies_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child:
            Business_Studies_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Business_Studies_Home_AlState extends State<Business_Studies_Home_Al>
  ...
  // Business_Studies_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Business Studies (A/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          AlBusinesStudyPaperBankAl(
                                            title: "BS Paper Bank (A/L)",
                                          )));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
