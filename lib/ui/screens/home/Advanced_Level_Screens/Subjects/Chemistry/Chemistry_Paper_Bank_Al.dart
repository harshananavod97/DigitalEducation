...
class ChemestryPaperBankAl extends StatefulWidget {
  String title;
  ChemestryPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<ChemestryPaperBankAl> createState() => _ChemestryPaperBankAlState();
}

class _ChemestryPaperBankAlState extends State<ChemestryPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlChemestryController().getItems("123"),
