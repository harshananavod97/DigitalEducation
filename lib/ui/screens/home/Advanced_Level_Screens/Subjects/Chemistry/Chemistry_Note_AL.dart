...
class ChemistryNoteAl extends StatefulWidget {
  String title;
  ChemistryNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<ChemistryNoteAl> createState() => _ChemistryNoteAlState();
}

class _ChemistryNoteAlState extends State<ChemistryNoteAl> {
