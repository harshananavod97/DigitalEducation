...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Chemistry/Chemistry_Note_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Chemistry/Chemistry_Paper_Bank_Al.dart';
...
class Chimestry_Home_Screen extends StatefulWidget {
  const Chimestry_Home_Screen({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Chimestry_Home_Screen> createState() => _Chimestry_Home_ScreenState();

  static Route<Chimestry_Home_Screen> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Chimestry_Home_Screen(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Chimestry_Home_ScreenState extends State<Chimestry_Home_Screen>
  ...
  // Chimestry_Home_Screen horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Chemestry (A/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ChemestryPaperBankAl(
                                        title: 'Chemestry (A/l) Paper Bank'),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ChemistryNoteAl(
                                        title: 'Chemestry (A/l) Note'),
                                  ));
                            })
                      ],
                    );
