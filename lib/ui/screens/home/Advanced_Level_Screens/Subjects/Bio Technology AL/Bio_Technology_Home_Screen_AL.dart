...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Bio%20Technology%20AL/Bio_Technology_Note_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Bio%20Technology%20AL/Bio_Technology_Paper_Bank_Al.dart';
...
class Bio_Technology_Home_Al extends StatefulWidget {
  const Bio_Technology_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Bio_Technology_Home_Al> createState() => _Bio_Technology_Home_AlState();

  static Route<Bio_Technology_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child:
            Bio_Technology_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Bio_Technology_Home_AlState extends State<Bio_Technology_Home_Al>
  ...
  // Bio_Technology_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Bio Technology"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          AlBioTechnologyPaperBankAl(
                                            title: 'Bio Technology Paper Bank',
                                          )));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => BiotechnologyNoteAl(
                                            title: "Bio Technology Notes",
                                          )));
                            })
                      ],
                    );
