...
class BiotechnologyNoteAl extends StatefulWidget {
  String title;
  BiotechnologyNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<BiotechnologyNoteAl> createState() => _BiotechnologyNoteAlState();
}

class _BiotechnologyNoteAlState extends State<BiotechnologyNoteAl> {
