...
import 'package:flutterquiz/ui/controller/Al_Chemestry_Controller.dart';
import 'package:flutterquiz/ui/controller/Al_Ict_Controller.dart';
import 'package:flutterquiz/ui/controller/Al_Science_Controller.dart';
import 'package:flutterquiz/ui/controller/Al_genralKnowldge.dart';
import 'package:flutterquiz/ui/controller/Bio_Technology_Controller.dart';
...
class AlBioTechnologyPaperBankAl extends StatefulWidget {
  String title;
  AlBioTechnologyPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<AlBioTechnologyPaperBankAl> createState() =>
      _AlBioTechnologyPaperBankAlState();
}

class _AlBioTechnologyPaperBankAlState
    extends State<AlBioTechnologyPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlBioTechnology().getItems("123"),
                    ...
                    return ListView.builder(
                      itemCount:
                          UiUtils.getCurrentQuestionLanguageId(context) == "57"
                              ? _list[0].S_Paper.length
                              : UiUtils.getCurrentQuestionLanguageId(context) ==
                                      "14"
                                  ? _list[0].E_Paper.length
                                  : _list[0].T_Paper.length,
                        ...
                        return Padding(
                          ...
                          child: ItemView(
                            ...
                            name: UiUtils.getCurrentQuestionLanguageId(
                                        context) ==
                                    "57"
                                ? _list[0].S_Paper_Title[index].toString()
                                : UiUtils.getCurrentQuestionLanguageId(
                                            context) ==
                                        "14"
                                    ? _list[0].E_Paper_Title[index].toString()
                                    : _list[0].T_Paper_Title[index].toString(),
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => PdfViewScreen(
                                            url: UiUtils.getCurrentQuestionLanguageId(
                                                        context) ==
                                                    "57"
                                                ? _list[0]
                                                    .S_Paper[index]
