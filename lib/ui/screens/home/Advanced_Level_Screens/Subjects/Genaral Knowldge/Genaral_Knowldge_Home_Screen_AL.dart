...
class GenaralKnowldge_Home_Al extends StatefulWidget {
  const GenaralKnowldge_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<GenaralKnowldge_Home_Al> createState() =>
      _GenaralKnowldge_Home_AlState();

  static Route<GenaralKnowldge_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child:
            GenaralKnowldge_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _GenaralKnowldge_Home_AlState extends State<GenaralKnowldge_Home_Al>
  ...
  // GenaralKnowldge_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Genaral Knowldge"),
                  ),
                ),
