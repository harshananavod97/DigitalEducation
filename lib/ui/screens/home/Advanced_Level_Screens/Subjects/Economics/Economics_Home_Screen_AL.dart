...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Economics/Economics_Knowldge_Note_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Economics/Economics_Knowldge_Paper_Bank_Al.dart';
...
class Economics_Home_Al extends StatefulWidget {
  const Economics_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Economics_Home_Al> createState() => _Economics_Home_AlState();

  static Route<Economics_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Economics_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Economics_Home_AlState extends State<Economics_Home_Al>
  ...
  // Economics_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Economics (A/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          EconomicsPaperBankAl(
                                            title: "Economics Paper Bank A/L",
                                          )));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => EconomicsNoteAl(
                                            title: "Economics Notes A/L",
                                          )));
                            })
                      ],
                    );
