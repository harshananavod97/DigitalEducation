...
import 'package:flutterquiz/ui/controller/Al_Economics_Controller.dart';
...
class EconomicsPaperBankAl extends StatefulWidget {
  String title;
  EconomicsPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<EconomicsPaperBankAl> createState() => _EconomicsPaperBankAlState();
}

class _EconomicsPaperBankAlState extends State<EconomicsPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlEconomicsController().getItems("123"),
