...
class EconomicsNoteAl extends StatefulWidget {
  String title;
  EconomicsNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<EconomicsNoteAl> createState() => _EconomicsNoteAlState();
}

class _EconomicsNoteAlState extends State<EconomicsNoteAl> {
