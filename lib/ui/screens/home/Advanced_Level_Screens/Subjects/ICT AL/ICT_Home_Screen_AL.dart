...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/ICT%20AL/ICT_Note_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/ICT%20AL/ICT_Paper_Bank_Al.dart';
...
class ICT_Home_Al extends StatefulWidget {
  const ICT_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<ICT_Home_Al> createState() => _ICT_Home_AlState();

  static Route<ICT_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: ICT_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _ICT_Home_AlState extends State<ICT_Home_Al> with WidgetsBindingObserver {
  /// Quiz Zone globals
  ...
  // ICT_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("ICT (A/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => IctPaperBankAl(
                                      title: "ICT PaperBank A/L ",
                                    ),
                                  ));
                            }),
                        SubButtons(
