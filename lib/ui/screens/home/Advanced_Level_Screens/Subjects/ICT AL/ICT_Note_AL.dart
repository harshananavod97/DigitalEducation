...
class IctNoteAl extends StatefulWidget {
  String title;
  IctNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<IctNoteAl> createState() => _IctNoteAlState();
}

class _IctNoteAlState extends State<IctNoteAl> {
