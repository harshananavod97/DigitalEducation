...
class IctPaperBankAl extends StatefulWidget {
  String title;
  IctPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<IctPaperBankAl> createState() => _IctPaperBankAlState();
}

class _IctPaperBankAlState extends State<IctPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlIctController().getItems("123"),
