...
class ScienceForTechnologyNoteAl extends StatefulWidget {
  String title;
  ScienceForTechnologyNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<ScienceForTechnologyNoteAl> createState() =>
      _ScienceForTechnologyNoteAlState();
}

class _ScienceForTechnologyNoteAlState
    extends State<ScienceForTechnologyNoteAl> {
