...
import 'package:flutterquiz/ui/controller/Al_Science_For_Technology.dart';
...
class ScienceForTechnologyPaperBankAl extends StatefulWidget {
  String title;
  ScienceForTechnologyPaperBankAl({Key? key, required this.title})
      : super(key: key);

  @override
  State<ScienceForTechnologyPaperBankAl> createState() =>
      _ScienceForTechnologyPaperBankAlState();
}

class _ScienceForTechnologyPaperBankAlState
    extends State<ScienceForTechnologyPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlsciencefortechnologyController().getItems("123"),
