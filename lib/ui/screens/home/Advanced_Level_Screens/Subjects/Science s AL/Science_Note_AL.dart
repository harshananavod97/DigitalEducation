...
class ScienceNoteAl extends StatefulWidget {
  String title;
  ScienceNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<ScienceNoteAl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<ScienceNoteAl> {
