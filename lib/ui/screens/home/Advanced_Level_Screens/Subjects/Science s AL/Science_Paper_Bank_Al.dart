...
class SciencePaperBankAl extends StatefulWidget {
  String title;
  SciencePaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<SciencePaperBankAl> createState() => _SciencePaperBankAlState();
}

class _SciencePaperBankAlState extends State<SciencePaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlScienceController().getItems("123"),
