...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Maths%20AL/Maths_Paper_Bank_Al.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Science%20s%20AL/Science_Note_AL.dart';
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Science%20s%20AL/Science_Paper_Bank_Al.dart';
...
class Science_Home_Al extends StatefulWidget {
  const Science_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Science_Home_Al> createState() => _Science_Home_AlState();

  static Route<Science_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Science_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Science_Home_AlState extends State<Science_Home_Al>
  ...
  // Science_Home_Al horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Science (A/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SciencePaperBankAl(
                                      title: "Biology A/L Paper Bank",
                                    ),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ScienceNoteAl(
                                      title: "Biology A/L Note",
                                    ),
                                  ));
                            })
                      ],
