...
class PhysicsNoteAl extends StatefulWidget {
  String title;
  PhysicsNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<PhysicsNoteAl> createState() => _PhysicsNoteAlState();
}

class _PhysicsNoteAlState extends State<PhysicsNoteAl> {
