...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Physics%20AL/Physics_Note_AL.dart';
...
import 'Physics_Paper_Bank_Al.dart';

class Physics_Home_AL extends StatefulWidget {
  const Physics_Home_AL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Physics_Home_AL> createState() => _Physics_Home_ALState();

  static Route<Physics_Home_AL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Physics_Home_AL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Physics_Home_ALState extends State<Physics_Home_AL>
  ...
  // Physics_Home_AL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Physics (A/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => PhysicsPaperBankAl(
                                      title: "Physics Paper Bank (A/L)",
                                    ),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => PhysicsNoteAl(
                                      title: "Physics Notes (A/L)",
                                    ),
                                  ));
                            })
                      ],
