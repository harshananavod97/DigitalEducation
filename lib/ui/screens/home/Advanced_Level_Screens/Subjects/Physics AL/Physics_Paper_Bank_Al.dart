...
import 'package:flutterquiz/ui/controller/Al_Physics_Controller.dart';
...
class PhysicsPaperBankAl extends StatefulWidget {
  String title;
  PhysicsPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<PhysicsPaperBankAl> createState() => _PhysicsPaperBankAlState();
}

class _PhysicsPaperBankAlState extends State<PhysicsPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: AlPhysicsController().getItems("123"),
