...
import 'package:flutterquiz/ui/screens/home/Advanced_Level_Screens/Subjects/Accounting/Accounting_Paper_Bank_Al.dart';
...
class Accounting_Home_Al extends StatefulWidget {
  const Accounting_Home_Al({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Accounting_Home_Al> createState() => _Accounting_Home_AlState();

  static Route<Accounting_Home_Al> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Accounting_Home_Al(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Accounting_Home_AlState extends State<Accounting_Home_Al>
  ...
  // Accounting_Home_Al horizontal margin, change from here
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          AccountingPaperBankAl(
                                            title: "Accounting Paper Bank A/L",
                                          )));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => AccountingNoteAl(
                                            title: "Accounting Note A/L ",
                                          )));
                            })
                      ],
                    );
