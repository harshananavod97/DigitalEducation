...
class AccountingNoteAl extends StatefulWidget {
  String title;
  AccountingNoteAl({Key? key, required this.title}) : super(key: key);

  @override
  State<AccountingNoteAl> createState() => _BiotechnologyNoteAlState();
}

class _BiotechnologyNoteAlState extends State<AccountingNoteAl> {
