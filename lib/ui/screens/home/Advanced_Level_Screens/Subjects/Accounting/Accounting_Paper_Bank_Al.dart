...
import 'package:flutterquiz/ui/controller/Al_Accounting.dart';
...
class AccountingPaperBankAl extends StatefulWidget {
  String title;
  AccountingPaperBankAl({Key? key, required this.title}) : super(key: key);

  @override
  State<AccountingPaperBankAl> createState() => _AccountingPaperBankAlState();
}

class _AccountingPaperBankAlState extends State<AccountingPaperBankAl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Al_AcountingController().getItems("123"),
