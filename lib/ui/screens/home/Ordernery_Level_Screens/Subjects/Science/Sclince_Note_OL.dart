...
class ScienceNoteOl extends StatefulWidget {
  String title;
  ScienceNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<ScienceNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<ScienceNoteOl> {
