...
class SciencePaperBankOl extends StatefulWidget {
  String title;
  SciencePaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<SciencePaperBankOl> createState() => _SciencePaperBankOlState();
}

class _SciencePaperBankOlState extends State<SciencePaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: OL_ScienceController().getItems("123"),
