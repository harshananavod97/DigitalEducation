...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Science/Science_Paper_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Science/Sclince_Note_OL.dart';
...
class Science_Home_OL extends StatefulWidget {
  const Science_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Science_Home_OL> createState() => _Science_Home_OLState();

  static Route<Science_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Science_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Science_Home_OLState extends State<Science_Home_OL>
  ...
  // Science_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Science (O/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SciencePaperBankOl(
                                        title: "Science O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        ScienceNoteOl(title: "Science O/L"),
                                  ));
                            })
                      ],
                    );
