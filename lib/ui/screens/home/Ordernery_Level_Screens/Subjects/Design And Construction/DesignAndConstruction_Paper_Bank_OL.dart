...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OlDesignandConstruction.dart';
...
class DesignConstructionPaperBankOl extends StatefulWidget {
  String title;
  DesignConstructionPaperBankOl({Key? key, required this.title})
      : super(key: key);

  @override
  State<DesignConstructionPaperBankOl> createState() =>
      _DesignConstructionPaperBankOlState();
}

class _DesignConstructionPaperBankOlState
    extends State<DesignConstructionPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_DesignAndConstruction().getItems("123"),
