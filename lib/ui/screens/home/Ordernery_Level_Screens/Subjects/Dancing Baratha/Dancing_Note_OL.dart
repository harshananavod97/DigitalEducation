...
class DancingBarathaNoteOl extends StatefulWidget {
  String title;
  DancingBarathaNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<DancingBarathaNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<DancingBarathaNoteOl> {
