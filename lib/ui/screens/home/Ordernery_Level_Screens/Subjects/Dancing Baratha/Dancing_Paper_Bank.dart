...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Dance_Baratha.dart';
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Dancing_Orental.dart';
...
class DancingBarthaPaperBankOl extends StatefulWidget {
  String title;
  DancingBarthaPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<DancingBarthaPaperBankOl> createState() =>
      _DancingBarthaPaperBankOlState();
}

class _DancingBarthaPaperBankOlState extends State<DancingBarthaPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Dancing_Baratha_Controller().getItems("123"),
