...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Maths.dart';
...
class MathsPaperBankOl extends StatefulWidget {
  String title;
  MathsPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<MathsPaperBankOl> createState() => _SciencePaperBankOlState();
}

class _SciencePaperBankOlState extends State<MathsPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Maths_Controller().getItems("123"),
