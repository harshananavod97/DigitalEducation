...
class MathsNoteOl extends StatefulWidget {
  String title;
  MathsNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<MathsNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<MathsNoteOl> {
