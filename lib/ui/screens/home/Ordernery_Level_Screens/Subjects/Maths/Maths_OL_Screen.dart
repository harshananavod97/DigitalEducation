...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Maths/Maths_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Maths/Maths_Paper_Bank_OL.dart';
...
class Maths_Home_OL extends StatefulWidget {
  const Maths_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Maths_Home_OL> createState() => _Maths_Home_OLState();

  static Route<Maths_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Maths_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Maths_Home_OLState extends State<Maths_Home_OL>
  ...
  // Maths_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Maths (O/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        MathsPaperBankOl(title: "Maths O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
