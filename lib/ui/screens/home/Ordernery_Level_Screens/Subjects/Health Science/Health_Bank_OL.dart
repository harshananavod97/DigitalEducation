...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_health_Science.dart';
...
class HealthSciencePaperBankOl extends StatefulWidget {
  String title;
  HealthSciencePaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<HealthSciencePaperBankOl> createState() => _HealthSciencePaperBankOlState();
}

class _HealthSciencePaperBankOlState extends State<HealthSciencePaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: OL_HealthScienceController().getItems("123"),
