...
class Art_Home_OL extends StatefulWidget {
  const Art_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Art_Home_OL> createState() => _Art_Home_OLState();

  static Route<Art_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Art_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Art_Home_OLState extends State<Art_Home_OL> with WidgetsBindingObserver {
  /// Quiz Zone globals
  ...
  // Art_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Art (O/l)"),
                  ),
                ),
