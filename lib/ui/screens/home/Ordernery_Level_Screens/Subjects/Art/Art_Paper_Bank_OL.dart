...
class ArtPaperBankOl extends StatefulWidget {
  String title;
  ArtPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<ArtPaperBankOl> createState() => _ArtPaperBankOlState();
}

class _ArtPaperBankOlState extends State<ArtPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Artcontroller().getItems("123"),
