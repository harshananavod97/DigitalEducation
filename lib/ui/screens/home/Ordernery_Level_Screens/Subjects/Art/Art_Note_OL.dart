...
class ArtNoteOl extends StatefulWidget {
  String title;
  ArtNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<ArtNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<ArtNoteOl> {
