...
class ICTNoteOl extends StatefulWidget {
  String title;
  ICTNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<ICTNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<ICTNoteOl> {
