...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Media.dart';
...
class MediaPaperBankOl extends StatefulWidget {
  String title;
  MediaPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<MediaPaperBankOl> createState() => _MediaPaperBankOlState();
}

class _MediaPaperBankOlState extends State<MediaPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Mediacontroller().getItems("123"),
