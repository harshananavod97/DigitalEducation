...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Media/Media_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Media/Media_Paper_Bank_OL.dart';
...
class Media_Home_OL extends StatefulWidget {
  const Media_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Media_Home_OL> createState() => _Media_Home_OLState();

  static Route<Media_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Media_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Media_Home_OLState extends State<Media_Home_OL>
  ...
  // Media_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Media (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        MediaPaperBankOl(title: "Media O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
