...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OlEnterprenership.dart';
...
class EnterPrenerShipPaperBankOl extends StatefulWidget {
  String title;
  EnterPrenerShipPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<EnterPrenerShipPaperBankOl> createState() =>
      _EnterPrenerShipPaperBankOlState();
}

class _EnterPrenerShipPaperBankOlState
    extends State<EnterPrenerShipPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_EnterPrenerShip().getItems("123"),
