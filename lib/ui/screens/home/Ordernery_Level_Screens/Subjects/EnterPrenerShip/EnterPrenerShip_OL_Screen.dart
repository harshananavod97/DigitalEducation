...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/EnterPrenerShip/EnterPrenerShip_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/EnterPrenerShip/EnterPrenerShip_Paper_Bank_OL.dart';
...
class EnterPrenerShip_Home_OL extends StatefulWidget {
  const EnterPrenerShip_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<EnterPrenerShip_Home_OL> createState() =>
      _EnterPrenerShip_Home_OLState();

  static Route<EnterPrenerShip_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child:
            EnterPrenerShip_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _EnterPrenerShip_Home_OLState extends State<EnterPrenerShip_Home_OL>
  ...
  // EnterPrenerShip_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("EnterPrenerShip (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        EnterPrenerShipPaperBankOl(
                                            title: "Entrepreneurship O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EnterPrenerShipNoteOl(
                                        title: "Entrepreneurship O/L"),
                                  ));
                            })
                      ],
