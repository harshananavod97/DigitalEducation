...
class EnterPrenerShipNoteOl extends StatefulWidget {
  String title;
  EnterPrenerShipNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<EnterPrenerShipNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<EnterPrenerShipNoteOl> {
