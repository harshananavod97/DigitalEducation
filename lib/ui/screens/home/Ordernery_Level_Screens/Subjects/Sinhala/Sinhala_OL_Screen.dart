...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Sinhala/Sinhala_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Sinhala/Sinhala_Note_OL.dart';
...
class Sinhala_Home_OL extends StatefulWidget {
  const Sinhala_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Sinhala_Home_OL> createState() => _Sinhala_Home_OLState();

  static Route<Sinhala_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Sinhala_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Sinhala_Home_OLState extends State<Sinhala_Home_OL>
  ...
  // Sinhala_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Accounting (A/l)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => SinhalaPaperBankOl(
                                        title: "Sinhala O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        SinhalaNoteOl(title: "Sinhala O/L"),
                                  ));
                            })
                      ],
                    );
