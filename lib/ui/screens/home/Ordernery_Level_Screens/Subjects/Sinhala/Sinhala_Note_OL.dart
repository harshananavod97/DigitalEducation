...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Sinhala.dart';
...
class SinhalaNoteOl extends StatefulWidget {
  String title;
  SinhalaNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<SinhalaNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<SinhalaNoteOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: OL_SinhalaController().getItems("123"),
