...
class SinhalaPaperBankOl extends StatefulWidget {
  String title;
  SinhalaPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<SinhalaPaperBankOl> createState() => _SinhalaPaperBankOlState();
}

class _SinhalaPaperBankOlState extends State<SinhalaPaperBankOl> {
