...
class TamilNoteOl extends StatefulWidget {
  String title;
  TamilNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<TamilNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<TamilNoteOl> {
