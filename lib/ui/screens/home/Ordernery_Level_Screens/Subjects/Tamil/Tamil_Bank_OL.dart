...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Tamil.dart';
...
class TamilPaperBankOl extends StatefulWidget {
  String title;
  TamilPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<TamilPaperBankOl> createState() => _SciencePaperBankOlState();
}

class _SciencePaperBankOlState extends State<TamilPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_TamilController().getItems("123"),
