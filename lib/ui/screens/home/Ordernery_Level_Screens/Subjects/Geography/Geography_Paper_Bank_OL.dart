...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Geography.dart';
...
class GeographyPaperBankOl extends StatefulWidget {
  String title;
  GeographyPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<GeographyPaperBankOl> createState() => _GeographyPaperBankOlState();
}

class _GeographyPaperBankOlState extends State<GeographyPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Geographycontroller().getItems("123"),
