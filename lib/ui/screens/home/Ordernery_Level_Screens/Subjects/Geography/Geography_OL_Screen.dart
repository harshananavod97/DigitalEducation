...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Geography/Geography_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Geography/Geography_Paper_Bank_OL.dart';
...
class Geography_Home_OL extends StatefulWidget {
  const Geography_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Geography_Home_OL> createState() => _Art_Home_OLState();

  static Route<Geography_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Geography_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Art_Home_OLState extends State<Geography_Home_OL>
  ...
  // Geography_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Geography (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => GeographyPaperBankOl(
                                        title: "Geography O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        GeographyNoteOl(title: "Geography O/L"),
                                  ));
                            })
                      ],
                    );
