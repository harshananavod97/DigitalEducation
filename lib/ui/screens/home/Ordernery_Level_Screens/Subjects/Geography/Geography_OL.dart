...
class GeographyNoteOl extends StatefulWidget {
  String title;
  GeographyNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<GeographyNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<GeographyNoteOl> {
