...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Drama.dart';
...
class DramaPaperBankOl extends StatefulWidget {
  String title;
  DramaPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<DramaPaperBankOl> createState() => _DramaPaperBankOlState();
}

class _DramaPaperBankOlState extends State<DramaPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: OL_DramaController().getItems("123"),
