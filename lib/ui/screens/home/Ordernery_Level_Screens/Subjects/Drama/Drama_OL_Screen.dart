...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Drama/Drama_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Drama/Drama_Note_OL.dart';
...
class Drama_Home_OL extends StatefulWidget {
  const Drama_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Drama_Home_OL> createState() => _English_Home_OLState();

  static Route<Drama_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Drama_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _English_Home_OLState extends State<Drama_Home_OL>
  ...
  // Drama_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Drama (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        DramaPaperBankOl(title: "Drama O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
