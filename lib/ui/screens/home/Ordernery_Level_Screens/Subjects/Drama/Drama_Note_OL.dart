...
class DramaNoteOl extends StatefulWidget {
  String title;
  DramaNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<DramaNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<DramaNoteOl> {
