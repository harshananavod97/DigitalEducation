...
class EconomicNoteOl extends StatefulWidget {
  String title;
  EconomicNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<EconomicNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<EconomicNoteOl> {
