...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Economic.dart';
...
class EconomicPaperBankOl extends StatefulWidget {
  String title;
  EconomicPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<EconomicPaperBankOl> createState() => _EconomicPaperBankOlState();
}

class _EconomicPaperBankOlState extends State<EconomicPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Economiccontroller().getItems("123"),
