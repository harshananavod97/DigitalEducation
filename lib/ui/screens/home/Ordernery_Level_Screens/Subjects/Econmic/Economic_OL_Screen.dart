...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Econmic/Economic_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Econmic/Economic_Paper_Bank_OL.dart';
...
class Economic_Home_OL extends StatefulWidget {
  const Economic_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Economic_Home_OL> createState() => _Economic_Home_OLState();

  static Route<Economic_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Economic_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Economic_Home_OLState extends State<Economic_Home_OL>
  ...
  // Economic_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Economic (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EconomicPaperBankOl(
                                        title: "Economic O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        EconomicNoteOl(title: "Economic O/L"),
                                  ));
                            })
                      ],
                    );
