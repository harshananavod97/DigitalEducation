...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Buddhism.dart';
...
class BuddhismPaperBankOl extends StatefulWidget {
  String title;
  BuddhismPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<BuddhismPaperBankOl> createState() => _BuddhismPaperBankOlState();
}

class _BuddhismPaperBankOlState extends State<BuddhismPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_BuddhismController().getItems("123"),
