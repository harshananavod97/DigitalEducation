...
class BuddhismNoteOl extends StatefulWidget {
  String title;
  BuddhismNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<BuddhismNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<BuddhismNoteOl> {
