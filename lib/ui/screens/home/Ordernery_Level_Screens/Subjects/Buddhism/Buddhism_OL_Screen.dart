...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Buddhism/Buddhism_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Buddhism/Buddhism_Note_OL.dart';
...
class Buddhism_Home_OL extends StatefulWidget {
  const Buddhism_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Buddhism_Home_OL> createState() => _Buddhism_Home_OLState();

  static Route<Buddhism_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Buddhism_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Buddhism_Home_OLState extends State<Buddhism_Home_OL>
  ...
  // Buddhism_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Buddhism (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => BuddhismPaperBankOl(
                                        title: "Buddhism O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        BuddhismNoteOl(title: "Buddhism O/L"),
                                  ));
                            })
                      ],
                    );
