...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Agriculture/Agriculture_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Agriculture/Agriculture_Paper_Bank_OL.dart';
...
class Agriculture_Home_OL extends StatefulWidget {
  const Agriculture_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Agriculture_Home_OL> createState() => _Agriculture_Home_OLState();

  static Route<Agriculture_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Agriculture_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Agriculture_Home_OLState extends State<Agriculture_Home_OL>
  ...
  // Agriculture_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Agriculture (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        AgriculturePaperBankOl(
                                            title: "Agriculture O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => AgricultureNoteOl(
                                        title: "Agriculture O/L"),
                                  ));
                            })
                      ],
