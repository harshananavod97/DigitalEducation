...
class AgricultureNoteOl extends StatefulWidget {
  String title;
  AgricultureNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<AgricultureNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<AgricultureNoteOl> {
