...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Agriculture.dart';
...
class AgriculturePaperBankOl extends StatefulWidget {
  String title;
  AgriculturePaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<AgriculturePaperBankOl> createState() => _AgriculturePaperBankOlState();
}

class _AgriculturePaperBankOlState extends State<AgriculturePaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Agricontroller().getItems("123"),
