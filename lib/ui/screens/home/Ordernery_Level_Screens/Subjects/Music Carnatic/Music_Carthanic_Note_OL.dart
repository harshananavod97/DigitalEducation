...
import 'package:flutterquiz/ui/controller/OL%20Controllers/Ol_Music_Carnatic.dart';
...
class Music_CarnaticNoteOl extends StatefulWidget {
  String title;
  Music_CarnaticNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<Music_CarnaticNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<Music_CarnaticNoteOl> {
