...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/OL%20Design%20And%20Material/DandM_Note_OL.dart';
...
class DesignandMaterial_Home_OL extends StatefulWidget {
  const DesignandMaterial_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<DesignandMaterial_Home_OL> createState() =>
      _DesignandMaterial_Home_OLState();

  static Route<DesignandMaterial_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: DesignandMaterial_Home_OL(
...
class _DesignandMaterial_Home_OLState extends State<DesignandMaterial_Home_OL>
  ...
  // DesignandMaterial_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("OL Design And Material (O/L)"),
                  ),
                ),
