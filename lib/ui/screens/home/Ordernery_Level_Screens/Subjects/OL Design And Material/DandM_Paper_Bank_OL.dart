...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OlDesignAndMaterial.dart';
...
class DesignandMaterialPaperBankOl extends StatefulWidget {
  String title;
  DesignandMaterialPaperBankOl({Key? key, required this.title})
      : super(key: key);

  @override
  State<DesignandMaterialPaperBankOl> createState() =>
      _DesignandMaterialPaperBankOlState();
}

class _DesignandMaterialPaperBankOlState
    extends State<DesignandMaterialPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_DesignAndMaterialcontroller().getItems("123"),
