...
class DesignandMaterialNoteOl extends StatefulWidget {
  String title;
  DesignandMaterialNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<DesignandMaterialNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<DesignandMaterialNoteOl> {
