...
class EnglishNoteOl extends StatefulWidget {
  String title;
  EnglishNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<EnglishNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<EnglishNoteOl> {
