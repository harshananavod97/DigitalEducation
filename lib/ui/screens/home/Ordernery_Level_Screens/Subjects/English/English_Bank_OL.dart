...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_English.dart';
...
class EnglishPaperBankOl extends StatefulWidget {
  String title;
  EnglishPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<EnglishPaperBankOl> createState() => _EnglishPaperBankOlState();
}

class _EnglishPaperBankOlState extends State<EnglishPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_EnglishController().getItems("123"),
