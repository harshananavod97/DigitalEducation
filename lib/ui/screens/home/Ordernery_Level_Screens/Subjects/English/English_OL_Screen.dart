...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/English/English_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/English/English_Note_OL.dart';
...
class English_Home_OL extends StatefulWidget {
  const English_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<English_Home_OL> createState() => _English_Home_OLState();

  static Route<English_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: English_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _English_Home_OLState extends State<English_Home_OL>
  ...
  // English_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("English (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EnglishPaperBankOl(
                                        title: "English O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        EnglishNoteOl(title: "English O/L"),
                                  ));
                            })
                      ],
                    );
