...
class DancingPaperBankOl extends StatefulWidget {
  String title;
  DancingPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<DancingPaperBankOl> createState() => _DancingPaperBankOlState();
}

class _DancingPaperBankOlState extends State<DancingPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Dancing_Orental_Controller().getItems("123"),
