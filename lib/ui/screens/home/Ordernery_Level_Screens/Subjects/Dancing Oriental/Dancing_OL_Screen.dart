...
class Dancing_Home_OL extends StatefulWidget {
  const Dancing_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Dancing_Home_OL> createState() => _English_Home_OLState();

  static Route<Dancing_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Dancing_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _English_Home_OLState extends State<Dancing_Home_OL>
  ...
  // Dancing_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Dancing Oriental (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => DancingPaperBankOl(
                                        title: "Dancing O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        DancingNoteOl(title: "Dancing O/L"),
                                  ));
                            })
                      ],
                    );
