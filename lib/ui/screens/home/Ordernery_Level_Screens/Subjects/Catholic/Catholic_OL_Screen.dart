...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Catholic/Catholic_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Catholic/Catholic_Note_OL.dart';
...
class Catholic_Home_OL extends StatefulWidget {
  const Catholic_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Catholic_Home_OL> createState() => _Catholic_Home_OLState();

  static Route<Catholic_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Catholic_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Catholic_Home_OLState extends State<Catholic_Home_OL>
  ...
  // Catholic_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Catholic (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => CatholicPaperBankOl(
                                        title: "Catholic O/L"),
                                  ));
                            }),
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        CatholicNoteOl(title: "Catholic O/L"),
                                  ));
                            })
                      ],
                    );
