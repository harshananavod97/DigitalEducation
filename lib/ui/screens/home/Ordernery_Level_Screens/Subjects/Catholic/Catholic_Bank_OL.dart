...
class CatholicPaperBankOl extends StatefulWidget {
  String title;
  CatholicPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<CatholicPaperBankOl> createState() => _ArtPaperBankOlState();
}

class _ArtPaperBankOlState extends State<CatholicPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Catholiccontroller().getItems("123"),
