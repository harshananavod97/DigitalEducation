...
class CatholicNoteOl extends StatefulWidget {
  String title;
  CatholicNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<CatholicNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<CatholicNoteOl> {
