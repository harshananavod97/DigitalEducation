...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Civics/Civic_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Civics/Civic_Paper_Bank_OL.dart';
...
class Civic_Home_OL extends StatefulWidget {
  const Civic_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Civic_Home_OL> createState() => _Art_Home_OLState();

  static Route<Civic_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Civic_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Art_Home_OLState extends State<Civic_Home_OL>
  ...
  // Civic_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Civic (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        CivicPaperBankOl(title: "Civic O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
