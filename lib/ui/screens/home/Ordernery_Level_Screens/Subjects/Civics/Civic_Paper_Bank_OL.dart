...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_CivicController.dart';
...
class CivicPaperBankOl extends StatefulWidget {
  String title;
  CivicPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<CivicPaperBankOl> createState() => _CivicPaperBankOlState();
}

class _CivicPaperBankOlState extends State<CivicPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Civiccontroller().getItems("123"),
