...
class CivicNoteOl extends StatefulWidget {
  String title;
  CivicNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<CivicNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<CivicNoteOl> {
