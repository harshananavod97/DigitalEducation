...
class ElectronicAndElectricalNoteOl extends StatefulWidget {
  String title;
  ElectronicAndElectricalNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<ElectronicAndElectricalNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<ElectronicAndElectricalNoteOl> {
