...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Art.dart';
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_ElectronicAndElectrical.dart';
...
class ElectronicAndElectricalPaperBankOl extends StatefulWidget {
  String title;
  ElectronicAndElectricalPaperBankOl({Key? key, required this.title})
      : super(key: key);

  @override
  State<ElectronicAndElectricalPaperBankOl> createState() =>
      _ElectronicAndElectricalPaperBankOlState();
}

class _ElectronicAndElectricalPaperBankOlState
    extends State<ElectronicAndElectricalPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_ElectronicAndElectrical().getItems("123"),
