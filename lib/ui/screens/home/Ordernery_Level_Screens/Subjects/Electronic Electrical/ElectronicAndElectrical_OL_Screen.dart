...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Art/Art_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Art/Art_Paper_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Electronic%20Electrical/ElectronicAndElectrical_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Electronic%20Electrical/ElectronicAndElectrical_Paper_Bank_OL.dart';
...
class ElectronicAndElectrical_Home_OL extends StatefulWidget {
  const ElectronicAndElectrical_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<ElectronicAndElectrical_Home_OL> createState() =>
      _ElectronicAndElectrical_Home_OLState();

  static Route<ElectronicAndElectrical_Home_OL> route(
    ...
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: ElectronicAndElectrical_Home_OL(
...
class _ElectronicAndElectrical_Home_OLState
    extends State<ElectronicAndElectrical_Home_OL> with WidgetsBindingObserver {
  /// Quiz Zone globals
  ...
  // ElectronicAndElectrical_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Electronic Electrical (O/L)"),
                  ),
                ),
  ...
  Widget quizZoneCategories(String quizname) {
        ...
        if (state is QuizoneCategorySuccess) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              return category.categoryName! == quizname
                  ? ListTile(
                      contentPadding:
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        ElectronicAndElectricalPaperBankOl(
                                            title: "Electrical Electronic O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
...
class SubButtons extends StatelessWidget {
  const SubButtons(
      {super.key,
