...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Ict/ICT_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Ict/ICT_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Islam/Islam_Bank_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Islam/Islam_Note_OL.dart';
...
class Islam_Home_OL extends StatefulWidget {
  const Islam_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Islam_Home_OL> createState() => _Islam_Home_OLState();

  static Route<Islam_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Islam_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Islam_Home_OLState extends State<Islam_Home_OL>
  ...
  // Islam_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("ISLAM (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        IslamPaperBankOl(title: "Islam O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
