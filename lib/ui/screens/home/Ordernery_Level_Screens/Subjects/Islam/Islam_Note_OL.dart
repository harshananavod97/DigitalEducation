...
class IslamNoteOl extends StatefulWidget {
  String title;
  IslamNoteOl({Key? key, required this.title}) : super(key: key);

  @override
  State<IslamNoteOl> createState() => _ScienceNoteAlState();
}

class _ScienceNoteAlState extends State<IslamNoteOl> {
