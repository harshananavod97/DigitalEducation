...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Islam.dart';
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Science_Controller.dart';
...
class IslamPaperBankOl extends StatefulWidget {
  String title;
  IslamPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<IslamPaperBankOl> createState() => _IslamPaperBankOlState();
}

class _IslamPaperBankOlState extends State<IslamPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: Ol_Islam_Controlller().getItems("123"),
