...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Music%20Orental/Music_Orental_Note_OL.dart';
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/Subjects/Music%20Orental/Music_Orental_Paper_Bank_OL.dart';
...
class Music_Orental_Home_OL extends StatefulWidget {
  const Music_Orental_Home_OL({required this.isGuest, super.key});

  final bool isGuest;

  @override
  State<Music_Orental_Home_OL> createState() => _Music_Orental_Home_OLState();

  static Route<Music_Orental_Home_OL> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: Music_Orental_Home_OL(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}

class _Music_Orental_Home_OLState extends State<Music_Orental_Home_OL>
  ...
  // Music_Orental_Home_OL horizontal margin, change from here
              ...
              children: [
                Positioned(
                  child: Container(
                    ...
                    child: quizZoneCategories("Music Orental (O/L)"),
                  ),
                ),
                        ...
                        SubButtons(
                            ...
                            onpress: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        Music_OrentalPaperBankOl(
                                            title: "Music Orental O/L"),
                                  ));
                            }),
                        SubButtons(
                            Imagename: 'notes.png',
                            ...
                            onpress: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => Music_OrentalNoteOl(
                                        title: "Music Orental O/L"),
                                  ));
                            })
                      ],
