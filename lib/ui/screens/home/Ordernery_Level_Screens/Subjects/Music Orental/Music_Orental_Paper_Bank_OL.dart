...
import 'package:flutterquiz/ui/controller/OL%20Controllers/OL_Music_Orental.dart';
...
class Music_OrentalPaperBankOl extends StatefulWidget {
  String title;
  Music_OrentalPaperBankOl({Key? key, required this.title}) : super(key: key);

  @override
  State<Music_OrentalPaperBankOl> createState() =>
      _Music_OrentalPaperBankOlState();
}

class _Music_OrentalPaperBankOlState extends State<Music_OrentalPaperBankOl> {
            ...
            child: Consumer<PlayMartProvider>(
              builder: (context, value, child) {
                return StreamBuilder<QuerySnapshot>(
                  stream: OlMusic_Orental_Controller().getItems("123"),
