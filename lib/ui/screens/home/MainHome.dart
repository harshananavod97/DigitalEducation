...
import 'package:flutterquiz/ui/screens/Live%20Support/live_support.dart';
import 'package:flutterquiz/ui/screens/StudyTips/Study_Tips.dart';
...
import 'package:flutterquiz/ui/screens/home/Ordernery_Level_Screens/OL_Home_Screen.dart';
...
import 'package:flutterquiz/ui/screens/motivation/Day_Motivation.dart';
...
class MainHomeScreen extends StatefulWidget {
  const MainHomeScreen({required this.isGuest, super.key});
  ...
  static Route<MainHomeScreen> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        ...
        child: MainHomeScreen(isGuest: routeSettings.arguments! as bool),
      ),
    );
  }
}
...
class _MainHomeScreenState extends State<MainHomeScreen>
  ...
  // MainHomeScreen horizontal margin, change from here
                            ...
                            onpress: () {
                              if (widget.isGuest) {
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) =>
                                          const AdavancedLevelHomeScreen(
                                              isGuest: false),
                                    ));
                              }
                            },
                            ...
                            onpress: () {
                              if (widget.isGuest) {
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const StudyTips(),
                                    ));
                              }
                            },
                            name: 'Study Tips',
...
class MainStreamContainer extends StatelessWidget {
  const MainStreamContainer({
    super.key,
